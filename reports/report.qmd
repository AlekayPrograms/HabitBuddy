...
* [LINK to GITHUB](https://github.com/cmsc-vcu/cmsc427-sp2025-hw11-AlekayPrograms)
...
Habit Buddy is a motivational mobile app designed to help users build positive habits through tracking, challenges, and progress visualization. Homework 11 brings interactivity by integrating real-time data updates via React Native hooks, persistent state with global context, and an API fetch using useEffect.
